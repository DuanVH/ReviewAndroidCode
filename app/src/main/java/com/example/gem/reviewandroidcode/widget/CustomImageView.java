...
public class CustomImageView extends ImageView implements View.OnTouchListener {
  ...
  protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    ...
    matrix.postTranslate(CacheHelper.getInstance().getTranslateX(), CacheHelper.getInstance().getTranslateY());
//    matrix.postScale(1.5f, 1.5f, 0, 0);
  ...
  public void setSavedMatrix2(Matrix savedMatrix2) {
    matrix = savedMatrix2;
    this.savedMatrix = savedMatrix2;
    this.savedMatrix2 = savedMatrix2;
  }
